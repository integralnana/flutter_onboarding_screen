...
// primary: Colors.green,
      ...
      image: Center(
        child: Image.network('https://m.media-amazon.com/images/I/71H6pf8BSeL.jpg'),
      ),
...
// primary: Colors.green,
      ...
      image: Center(
        child: Image.network('https://m.media-amazon.com/images/I/71iW-Hl2ibL.jpg'),
      ),
      decoration: const PageDecoration(
        titleTextStyle: TextStyle(
          fontSize: 25.0,
